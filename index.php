<?php include "../estancia/view/header.php"; ?>
...
<head> 
    ...
    <link rel="stylesheet" href="../estancia/public/css/index.css">
</head>
<body>
    ...
    <div class="icon-text-wrapper flex-column flex-lg-row">
        ...
        <div class="button-right">
            <a href="../estancia/view/registro.php" class="register-button">REGÍSTRATE</a>
        </div>
    </div>
</body>
</html>
