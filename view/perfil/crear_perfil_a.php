...
include '../../../estancia/controller/mostrar_usuarios.php';
?>
    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header text-center">
                <h2>Crea un perfil para un usuario</h2>
            </div>
            <div class="card-body">
                <!-- Formulario de perfil -->
                <form action="../../controller/alta_perfil_a.php" method="POST" enctype="multipart/form-data" id="perfilForm" onsubmit="validarFormulario(event)">
                    <!-- Foto de perfil -->
                    ...
                    <!-- Campo para seleccionar ID de Alumno -->
                    <div class="form-group">
                        <label for="idAlumno">Seleccionar usuario:</label>
                        <select id="idAlumno" name="idAlumno" class="form-control">
                            ...
                            if (isset($usuarios)) {
                                foreach ($usuarios as $usuario) {
                                    echo "<option value='{$usuario['id']}'>{$usuario['nombre']} - {$usuario['tipo']} - Id del usuario: " . $usuario['id'] . "</option>";
