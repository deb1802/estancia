                        ...
                        <div class="card profile-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center mt-3">
                                    ...
                                    <a href="../../controller/eliminar_perfil.php?id=' . htmlspecialchars($profile['id']) . '" class="btn btn-danger" onclick="return confirm(\'¿Estás seguro de eliminar este perfil?\');">Eliminar</a>
                                </div>
                            </div>
                        </div>
                    </div>';
